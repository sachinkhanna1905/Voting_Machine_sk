...
SECRET_KEY = 'django-insecure-!0)++n-!8(48(sbzt+*(e3vb@*3y$-jy=+#gq@^pcojadhnc*y'
...
INSTALLED_APPS = [
    #  register your App
    # foler name -> file name-> function name 
...
TEMPLATES = [
    {
        ...
        # setting up our templates flies 
